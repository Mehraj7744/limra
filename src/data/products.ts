...
export const products: Product[] = [
...

  {
    ...
    slug: "limra-aeroflow-ceiling-fan",

    name: "LIMRA AeroFlow Ceiling Fan (Sample Product — Replace Details)",
    ...
    description: "The LIMRA AeroFlow ceiling fan delivers balanced air circulation and long-lasting motor durability. Built with precision-balanced blades and quality internal components under LIMRA INDUSTRIES quality standards.",
...

  {
    ...
    slug: "limra-breeze-deluxe-ceiling-fan",

    name: "LIMRA Breeze Deluxe Ceiling Fan (Sample Product — Replace Details)",
...

  {
    ...
    slug: "limra-economy-speed-ceiling-fan",

    name: "LIMRA Economy Speed 900mm (Sample Product — Replace Details)",
...

  {
    ...
    slug: "limra-airjet-table-fan",

    name: "LIMRA AirJet 400mm Table Fan (Sample Product — Replace Details)",
    ...
    description: "The LIMRA AirJet table fan features smooth 90-degree oscillation, 3-speed push-button control, and high-velocity aerodynamic blades encased in a safety grill. Built for continuous usage in Indian summer conditions.",
...

  {
    ...
    slug: "limra-compact-desk-fan",

    name: "LIMRA Compact Desk Fan 300mm (Sample Product — Replace Details)",
...

  {
    ...
    slug: "limra-stormflow-pedestal-fan",

    name: "LIMRA StormFlow Pedestal Fan (Sample Product — Replace Details)",
    ...
    description: "The LIMRA StormFlow pedestal fan provides commanding airflow for large spaces, restaurants, retail shops, and warehouses. Built with an ultra-stable round base, telescopic height rod, and robust oscillation mechanism.",
...

  {
    ...
    slug: "limra-commercial-high-thrust-pedestal-fan",

    name: "LIMRA High-Thrust Commercial Pedestal Fan (Sample Product — Replace Details)",
